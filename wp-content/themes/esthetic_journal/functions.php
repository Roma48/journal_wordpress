...
function twentyfifteen_scripts() {
	...
	wp_enqueue_style( 'esthetic_journal_layers', get_template_directory_uri() . '/css/layers.min.css', array(), '20141010' );
	wp_enqueue_style( 'font_awesome', get_template_directory_uri() . '/css/font-awesome.min.css', array( ), '20141010' );

	// Load our main stylesheet.
	wp_enqueue_style( 'esthetic_journal-style', get_stylesheet_uri(), array(), '20141011' );
